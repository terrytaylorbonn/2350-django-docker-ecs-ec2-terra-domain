...
resource "aws_instance" "web" {
  ...
  user_data = <<-EOF
    ...
    # Authenticate to ECR
    docker login -u AWS -p $(aws ecr get-login-password --region us-east-1) 619071323356.dkr.ecr.us-east-1.amazonaws.com

    # Pull the Docker image from ECR
    docker pull 619071323356.dkr.ecr.us-east-1.amazonaws.com/django-ec2-complete:latest
    ...
    --env DB_PORT=5432 \
    619071323356.dkr.ecr.us-east-1.amazonaws.com/django-ec2-complete:latest
    EOF
